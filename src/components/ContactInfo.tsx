...
const ContactInfo = () => {
  return (
    <section className="h-[70vh] flex items-center justify-center bg-gradient-to-br from-blue-50 via-gray-50 to-blue-100 px-4">
        ...
        <div className="text-center lg:text-left animate-fade-in">
          <div className="relative inline-block">
            <img
              ...
              className="w-48 h-48 rounded-full object-cover shadow-2xl mx-auto lg:mx-0"
            />
